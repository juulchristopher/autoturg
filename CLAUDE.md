...
Single-file SPA (`index.html`, ~3500 lines) with inline CSS + JS. No build step.
...
- Server-side scripts: `parse.py` (data pipeline), `fetch_prices.py` (pricing), `fetch_vehicle.py` (vehicle API), `scrape_vehicle.py` (vehicle lookup)
